                  ...
                  <Dialog.Title as="h3" className="text-gray-900 text-2xl font-extrabold my-5">
                    ...
                    <div className='mt-5 flex justify-between gap-4'>
                      ...
                      <button
                        ...
                        className='w-full rounded bg-orange-400 p-3 font-semibold text-xl uppercase text-white shadow hover:bg-orange-300'
                      > {favoriteExists(selectedRecipe.idDrink) ? '❤️' : '🤍'}</button>
                    </div>
